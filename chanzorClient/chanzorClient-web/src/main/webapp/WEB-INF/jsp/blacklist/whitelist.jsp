...
<div class='chanzorDataList'>
	...
	<form class="form-inline" style='text-align: right; margin-right: 2%;'>
		<div class="form-group">
			<label for="mdn" class='listLab'>手机号码：</label> <input type="text"
				class="form-control listInp" id="mdn" name="mdn" placeholder="">
		</div>
		<checkLand:check type="sessionUser">
			<div class="form-group">
				<label for="effectApp" class='listLab'>&nbsp;&nbsp;&nbsp;&nbsp;生效应用：</label>
				<select id="spid" name="spid" class="form-control m-b">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control listInp" id="queryStartTime" name="queryStartTime"
				placeholder="开始时间" style='text-align: center;'> -
		</div>
		<div class="form-group">
			<input type="text" class="form-control listInp" name="queryEndTime" id="queryEndTime"
				placeholder="截止时间" style="text-align: center;">
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 id="myModalLabel" class="modal-title">修改白名单</h4>
				</div>
				<form class="js-validation-upload-auth form-horizontal"
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="val-signusername">验证码
								<span class="text-danger">*</span>
							</label>
							<div class="col-md-4">
								<input class="form-control" type="text" id="edit_code"
									name="code" placeholder="验证码" maxlength="8" />
							</div>
							<div class="col-md-2">
								<button type="button" class="btn btn-default"
									onclick="getCode(this);">获取验证码</button>
							</div>
