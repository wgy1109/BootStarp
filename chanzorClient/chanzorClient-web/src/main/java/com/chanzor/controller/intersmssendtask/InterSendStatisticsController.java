...
@Controller
@RequestMapping("interSendStatistics")
@SuppressWarnings("unchecked")
public class InterSendStatisticsController extends BaseController {
	...
	public ModelAndView SendStatisticsmessage(PageInfo page) throws Exception {
		ModelAndView mv = new ModelAndView("interSmssendtaskClient/interSendStatisticsMessage");
		return mv;
	}
